...
public class CashBlastWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CashBlastWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CashBlastIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CashBlastIW/InitOutcome.xml").getDocumentElement();
